...
class LocalTag(Base):
    ...
    tag_uid: Mapped[str | None] = mapped_column(String(128), nullable=True)
    encrypted_token: Mapped[str] = mapped_column(String(256), default="")
    hw_model: Mapped[str | None] = mapped_column(String(128), nullable=True)
    fw_version: Mapped[str | None] = mapped_column(String(64), nullable=True)
    local_no: Mapped[int | None] = mapped_column(Integer, nullable=True)
    display_name: Mapped[str | None] = mapped_column(String(64), nullable=True)
    ble_name: Mapped[str | None] = mapped_column(String(128), nullable=True)
    ble_address: Mapped[str | None] = mapped_column(String(64), nullable=True)
    station_id: Mapped[str] = mapped_column(String(64), index=True)
