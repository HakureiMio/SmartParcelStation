...
- Keep the same logical names in firmware (`led-red-pwm`, `led-green-pwm`, `led-blue-pwm`, `buzzer-gpio`, `remove-sense`, `bat-adc`, `bat-div-en`) so application code does not need to change.
