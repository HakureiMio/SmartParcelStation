...
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_ALIAS|led-red-pwm" "/pwm_leds/led_r_pwm")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_ALIAS|led-green-pwm" "/pwm_leds/led_g_pwm")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_ALIAS|led-blue-pwm" "/pwm_leds/led_b_pwm")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_ALIAS|buzzer-pwm" "/pwm_leds/buzzer_pwm")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_ALIAS|bat-div-en" "/clip_outputs/bat_div_en")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_ALIAS|status-led" "/clip_outputs/status_led")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_ALIAS|remove-sense" "/clip_inputs/remove_sense")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_ALIAS|user-btn" "/clip_inputs/user_btn")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_ALIAS|bat-adc" "/zephyr,user")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_NODE|/" TRUE)
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_PROP|/|compatible" "smartparcel,clip-node-nrf52810;")
...
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_PROP|/pin-controller/pwm0_default/group1|psels" "369098763;385875980;402653199;419430416;")
...
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_PROP|/pin-controller/pwm0_sleep/group1|psels" "369098763;385875980;402653199;419430416;")
...
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_NODE|/pwm_leds/led_r_pwm" TRUE)
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_NODELABEL|led_r_pwm" "/pwm_leds/led_r_pwm")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_PROP|/pwm_leds/led_r_pwm|label" "RGB red PWM on P0.11")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_REG|/pwm_leds/led_r_pwm|NUM" "0")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_REG|/pwm_leds/led_r_pwm|ADDR" "")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_REG|/pwm_leds/led_r_pwm|SIZE" "")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_NODE|/pwm_leds/led_g_pwm" TRUE)
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_NODELABEL|led_g_pwm" "/pwm_leds/led_g_pwm")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_PROP|/pwm_leds/led_g_pwm|label" "RGB green PWM on P0.12")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_REG|/pwm_leds/led_g_pwm|NUM" "0")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_REG|/pwm_leds/led_g_pwm|ADDR" "")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_REG|/pwm_leds/led_g_pwm|SIZE" "")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_NODE|/pwm_leds/led_b_pwm" TRUE)
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_NODELABEL|led_b_pwm" "/pwm_leds/led_b_pwm")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_PROP|/pwm_leds/led_b_pwm|label" "RGB blue PWM on P0.15")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_REG|/pwm_leds/led_b_pwm|NUM" "0")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_REG|/pwm_leds/led_b_pwm|ADDR" "")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_REG|/pwm_leds/led_b_pwm|SIZE" "")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_NODE|/pwm_leds/buzzer_pwm" TRUE)
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_NODELABEL|buzzer_pwm" "/pwm_leds/buzzer_pwm")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_PROP|/pwm_leds/buzzer_pwm|label" "Passive buzzer PWM on P0.16")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_REG|/pwm_leds/buzzer_pwm|NUM" "0")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_REG|/pwm_leds/buzzer_pwm|ADDR" "")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_REG|/pwm_leds/buzzer_pwm|SIZE" "")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_NODE|/clip_outputs" TRUE)
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_PROP|/clip_outputs|compatible" "gpio-leds;")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_REG|/clip_outputs|NUM" "0")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_REG|/clip_outputs|ADDR" "")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_REG|/clip_outputs|SIZE" "")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_NODE|/clip_outputs/bat_div_en" TRUE)
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_NODELABEL|bat_div_en" "/clip_outputs/bat_div_en")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_PROP|/clip_outputs/bat_div_en|label" "Battery divider enable on P0.20")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_REG|/clip_outputs/bat_div_en|NUM" "0")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_REG|/clip_outputs/bat_div_en|ADDR" "")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_REG|/clip_outputs/bat_div_en|SIZE" "")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_NODE|/clip_outputs/status_led" TRUE)
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_NODELABEL|status_led" "/clip_outputs/status_led")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_PROP|/clip_outputs/status_led|label" "Optional status LED on P0.22")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_REG|/clip_outputs/status_led|NUM" "0")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_REG|/clip_outputs/status_led|ADDR" "")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_REG|/clip_outputs/status_led|SIZE" "")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_NODE|/clip_inputs" TRUE)
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_PROP|/clip_inputs|debounce-interval-ms" "30")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_PROP|/clip_inputs|polling-mode" "False")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_PROP|/clip_inputs|no-disconnect" "False")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_PROP|/clip_inputs|compatible" "gpio-keys;")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_PROP|/clip_inputs|zephyr,deferred-init" "False")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_PROP|/clip_inputs|wakeup-source" "False")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_PROP|/clip_inputs|zephyr,pm-device-runtime-auto" "False")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_REG|/clip_inputs|NUM" "0")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_REG|/clip_inputs|ADDR" "")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_REG|/clip_inputs|SIZE" "")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_NODE|/clip_inputs/remove_sense" TRUE)
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_NODELABEL|remove_sense" "/clip_inputs/remove_sense")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_PROP|/clip_inputs/remove_sense|label" "Clip remove sense on P0.19")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_REG|/clip_inputs/remove_sense|NUM" "0")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_REG|/clip_inputs/remove_sense|ADDR" "")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_REG|/clip_inputs/remove_sense|SIZE" "")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_NODE|/clip_inputs/user_btn" TRUE)
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_NODELABEL|user_btn" "/clip_inputs/user_btn")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_PROP|/clip_inputs/user_btn|label" "Optional user button on P0.21")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_REG|/clip_inputs/user_btn|NUM" "0")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_REG|/clip_inputs/user_btn|ADDR" "")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_REG|/clip_inputs/user_btn|SIZE" "")
...
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_COMP|smartparcel,clip-node-nrf52810" "/")
...
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_COMP|gpio-leds" "/clip_outputs")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_COMP|gpio-keys" "/clip_inputs")
